...
uint8 ComuSendDataFromBT(uint8 BTn,uint8 head, unsigned char* data_buffer, uint8 Nb_bytes);
uint8  ConverToPackedTelNum(unsigned char * buf,unsigned char maxlen,unsigned char * pNum);
void ConverDial2str(unsigned char * outbuf,unsigned char * dtmfbuf);
